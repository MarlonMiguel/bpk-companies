...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference("Attribute.count") do
      post attributes_url, params: { attribute: { description: @attribute.description, type: @attribute.type } }
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { description: @attribute.description, type: @attribute.type } }
