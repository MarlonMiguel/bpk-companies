...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference("Subcategory.count") do
      post subcategories_url, params: { subcategory: { name: @subcategory.name, parent_id: @subcategory.parent_id } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { name: @subcategory.name, parent_id: @subcategory.parent_id } }
